...
import com.desafiom2y.danilo.movies.databinding.ItemMovieBinding
import com.desafiom2y.danilo.movies.domain.model.Movie

class MovieSimilarListAdapter : PagingDataAdapter<Movie, MovieSimilarListAdapter.ViewHolder>(DiffCallback()) {
